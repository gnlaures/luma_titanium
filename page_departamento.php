<main class="l-innerPage" id="page__departamento">
	...
	<header class="l-headerTitleInner">
		<h1>Vestidos</h1>
	</header>
	<div class="l-contentWithAside">
		<div class="u-container u-containerFlex">
			<div class="l-contentWithAside__aside">
			...
			<div class="l-contentWithAside__content">
					...
					<div class="s-gridDpt__head">
						...
						<div class="head__changeView">
							<div class="changeView__orderBy">
								...
								<select name="#" id="#" class="field" required>
